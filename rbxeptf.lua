...
local venyx = library.new("Leod|Entry Point|The Financier", 5013109572)
...
--Power Box
n:addToggle("Esp Power Box", nil, function(value)
    if value then
...
n:addToggle("Esp Computer/Laptop", nil, function(value)
    if value then
        for i,v in pairs(game:GetService("Workspace").Level.Geometry:GetDescendants()) do
