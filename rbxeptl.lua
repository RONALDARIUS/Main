...
local venyx = library.new("Leod|Entry Point|The Lakehouse", 5013109572)
            ...
            if v.Name == "FileFolder" then
                if v.Base:FindFirstChild("ESP") then
                    wait()
                        ...
                        t.TextScaled = true
                        t.Size = UDim2.new(1, 0, 1, 0)
                        t.TextColor3 = Color3.new(1, 0.317647, 0)
                end
            end
        end
    else
            ...
            if v.Name == "PowerDoor" then
                if v.Color:FindFirstChild("ESP") then
                    wait()
                        ...
                        t.TextScaled = true
                        t.Size = UDim2.new(1, 0, 1, 0)
                        t.TextColor3 = Color3.new(0.933333, 1, 0)
                end
            end
        end
    else
